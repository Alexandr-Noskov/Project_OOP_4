...
"""Добрый день, Уважаемый Пользователь! С помощью данного сервиса можно подбирать и сортировать вакансии по нужным параметрам."""
def main():
...
(выдает только те специальности, у которых заработная плата в рублях)\n""").lower()
    vacancies = None
